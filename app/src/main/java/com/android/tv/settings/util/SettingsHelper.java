...
public class SettingsHelper {
    ...
    //xiezhiwen 20160730 add for 3to1 function for mantis 0742 start+++
    public boolean getPowerkey() {
        return TvCommonManager.getInstance().getPowerKeyMode() == 3;
    }

    public String getStatusStringFromIntPowerkey(int status) {
        int descResId = status == 3 ? R.string.system_powerkey_three :
                R.string.system_powerkey_off;
        return mResources.getString(descResId);
    }
    //xiezhiwen 20160730 add for 3to1 function for mantis 0742 end---
    /**
