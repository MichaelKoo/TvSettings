...
public class AppManagementActivity extends DialogActivity implements ActionAdapter.Listener,
    ...
    private ArrayList<Action> getActions() {
        ...
        // Workaround solution to prevent user clear Launcher data
        // Because Launcher will not restart after clear data.
        // We need to find a solution to fix it in ActivityManager in framework.
        if (!mPackageName.contains("launcher")) {
            actions.add(
