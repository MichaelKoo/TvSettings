...
enum ActionType {
    ...
    AUTO_TV_DATE_TIME(R.string.system_tv_auto_date_time, R.string.desc_tv_auto_date_time),
    ...
    // MStar Android Patch Begin
    KEYBOARD_OVERVIEW_USER_DICT(R.string.user_dict_settings_title),
    // MStar Android Patch End
     ...
     *Desktop Setting
     */
    DESKTOP_OVERVIEW(R.string.system_desktop),
    DESKTOP_WALLPAPER(R.string.system_wallpaper),
    DESKTOP_DESKTOP_CONTROL(R.string.system_desktop_control),
    /*xiezhiwen 20160729 add for 3to1 function for mantis 0742 start+++*/
    DESKTOP_POWERKEY_CONTROL(R.string.system_powerkey_switch),
    DESKTOP_POWERKEY_THREE(R.string.system_powerkey_three),
    DESKTOP_POWERKEY_OFF(R.string.system_powerkey_off),
    /*xiezhiwen 20160729 add for 3to1 function for mantis 0742 end---*/
    /*xiezhiwen 20160712 add for desktop end--- */
	//liyuanyuan 20160729 add childlock password set on mantis 0737 start+++
	GENERAL_CHILDLOCK_PWD_SET(R.string.system_childlock_pwd_set),
	//liyuanyuan 20160729 add childlock password set on mantis 0737 end---
