...
public class ConnectToWifiFragment extends MessageWizardFragment
    ...
    public static final int RESULT_ETHERNET_CONNECTED = 5;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (isEthernetConnected()) {
            notifyListener(RESULT_ETHERNET_CONNECTED);
        }
        // MStar Android Patch End
    ...
    private boolean isEthernetConnected() {
        ...
        if (netInfo.isConnected() && netInfo.getType() == ConnectivityManager.TYPE_ETHERNET) {
            return true;
        }
        return false;
    }
