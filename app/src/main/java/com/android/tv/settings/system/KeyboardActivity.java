...
import com.android.tv.settings.UserDictionarySettingsActivity;
    ...
    public void onActionClicked(Action action) {
        ...
        switch (type) {
            case KEYBOARD_OVERVIEW_CONFIGURE:
                ...
                return;
            // MStar Android Patch Begin
            case KEYBOARD_OVERVIEW_USER_DICT:
                startActivity(new Intent(this, UserDictionarySettingsActivity.class));
                return;
            // MStar Android Patch End
            default:
        }
    ...
    protected void refreshActionList() {
        ...
        switch ((ActionType) mState) {
            case KEYBOARD_OVERVIEW:
                ...
                // MStar Android Patch Begin
                mActions.add(ActionType.KEYBOARD_OVERVIEW_USER_DICT.toAction(mResources));
                // MStar Android Patch End
                break;
            case KEYBOARD_OVERVIEW_CURRENT_KEYBOARD:
