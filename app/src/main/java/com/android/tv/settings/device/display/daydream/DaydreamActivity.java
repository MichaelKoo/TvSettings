...
public class DaydreamActivity extends DialogActivity implements ActionAdapter.Listener {
    ...
    private ArrayList<Action> getMainActions() {
        ...
        String[] dreamTimeoutEntries = getResources().getStringArray(
                R.array.sleep_timeout_entries);
        int dreamTimeoutValue = getDreamTimeoutValue();
        String dreamTimeoutDescription = dreamTimeoutValue==Integer.MAX_VALUE?
                dreamTimeoutEntries[dreamTimeoutEntries.length - 1] :
                getString(R.string.device_daydreams_sleep_summary, getEntry(
                        R.array.sleep_timeout_values, R.array.sleep_timeout_entries, dreamTimeoutValue));
        ...
        actions.add(new Action.Builder()
                ...
                .description(dreamTimeoutDescription)
                .build());
