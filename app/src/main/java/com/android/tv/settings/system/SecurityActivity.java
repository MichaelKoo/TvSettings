...
public class SecurityActivity extends BaseSettingsActivity implements ActionAdapter.Listener {
    ...
    private static final String ACTION_DEVICE_ADMIN = "action_device_admin";
    ...
    protected void refreshActionList() {
        ...
        switch ((ActionType) mState) {
            case SECURITY_OVERVIEW:
                ...
                // MStar Android Patch Begin
                mActions.add(new Action.Builder().key(ACTION_DEVICE_ADMIN)
                        .title(getString(R.string.select_device_admin_msg))
                        .intent(new Intent(this, DeviceAdminSettingsActivity.class)).build());
                // MStar Android Patch End
                break;
            case SECURITY_UNKNOWN_SOURCES:
    ...
    public void onActionClicked(Action action) {
        // MStar Android Patch Begin
        if (ACTION_RESTRICTED_PROFILE.equals(action.getKey()) || ACTION_DEVICE_ADMIN.equals(action.getKey())) {
