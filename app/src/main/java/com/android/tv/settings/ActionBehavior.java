...
public enum ActionBehavior {
    ...
    //xiezhiwen 20160729 add for 3to1 function for mantis 0742 start+++
    public static String getPowerThreeKey(String typeName) {
        return typeName + ":" + ActionBehavior.DESKTOP_POWERKEY_THREE.name();
    }

    public static String getPowerOffKey(String typeName) {
        return typeName + ":" + ActionBehavior.DESKTOP_POWERKEY_OFF.name();
    }
    //xiezhiwen 20160729 add for 3to1 function for mantis 0742 end---
}
