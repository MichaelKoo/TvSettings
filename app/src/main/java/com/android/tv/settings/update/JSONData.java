...
import com.android.tv.settings.util.MD5Tools;
...
public class JSONData {
    ...
    private static final String TAG = "Settings.JSONData";

    private static final String JSON_URL = "http://tvosapp.babao.com/interface/clientService.jsp";
